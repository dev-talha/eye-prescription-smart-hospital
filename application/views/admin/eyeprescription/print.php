...
<div class="container-fluid">
    ...
    <div class="header-section text-center">
        <?php if (!empty($print_details['print_header'])) { ?>
            <img src="<?php echo $this->media_storage->getImageURL($print_details['print_header']); ?>" class="print-header-img">
        <?php } ?>
    </div>
    ...
    <div class="patient-info-row row g-0">
        <div class="col-3 border-end p-2">
            ...
            <p class="m-0"><strong>Gen. By:</strong> <?php echo $p['generated_by_name'] ? $p['generated_by_name'] . ' ' . $p['generated_by_surname'] : 'Admin'; ?></p>
        </div>
        ...
        <div class="col-5 p-2">
            <p class="m-0"><strong>Doctor:</strong> <?php echo $p['doctor_name'] . ' ' . $p['doctor_surname'] ; ?></p>
            <p class="m-0"><strong>Qual.:</strong> <?php echo $p['doctor_qualification']; ?></p>
            <?php if($p['doctor_specialization']){ ?><p class="m-0"><strong>Spec.:</strong> <?php echo $p['doctor_specialization']; ?></p><?php } ?>
            <?php if($p['doctor_work_exp']){ ?><p class="m-0"><strong>Exp.:</strong> <?php echo $p['doctor_work_exp']; ?> Years</p><?php } ?>
        </div>
    </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-4 border-end">
            <div class="pe-0">
                <?php if($p['dm'] != 'NA' || $p['htn'] != 'NA' || $p['rbs'] || $p['bp'] || $p['pulse'] || $p['chief_complaint'] || $p['medical_history'] || $p['surgical_history']){ ?>
                <div class="section-title">General Health</div>
                <?php if($p['chief_complaint']){ ?><p class="mb-1"><strong>C/C:</strong> <?php echo nl2br($p['chief_complaint']); ?></p><?php } ?>
                <?php if($p['medical_history']){ ?><p class="mb-1"><strong>Medical Hist.:</strong> <?php echo nl2br($p['medical_history']); ?></p><?php } ?>
                <?php if($p['surgical_history']){ ?><p class="mb-1"><strong>Surgical Hist.:</strong> <?php echo nl2br($p['surgical_history']); ?></p><?php } ?>
                
                <?php if($p['dm'] != 'NA' || $p['htn'] != 'NA' || $p['rbs']){ ?>
                <p class="mb-1">
                ...
                <?php if($p['diagnosis'] || $p['plan'] || $p['investigation'] || $p['counseling'] || $p['advice'] || $p['print_note']){ ?>
                ...
                <?php if($p['print_note']){ ?><p class="small mb-1"><strong>Print Note:</strong> <?php echo nl2br($p['print_note']); ?></p><?php } ?>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="col-8">
            ...
            <table class="table table-sm table-bw text-center  compact-table">
                <thead>
                    <tr>
            ...
            <table class="table table-sm table-bw medi-table compact-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong><?php echo $m['medicine_name']; ?></strong>
                            <?php if($m['instruction']){ ?><br> <small class="Instraction"><?php echo $m['instruction']; ?></small><?php } ?>
                        </td>
                        <td style="text-align:center"><?php echo $m['medicine_dosage']; ?></td>
                        <td style="text-align:center"><?php echo $m['dose_interval']; ?></td>
                        <td style="text-align:center"><?php echo $m['dose_duration']; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
    ...
    <div class="footer-section">
        ...
        <div class="text-center" style="margin-top:20px;">
            <?php if (!empty($print_details['print_footer'])) { ?>
                <img src="<?php echo $this->media_storage->getImageURL($print_details['print_footer']); ?>" class="img-responsive" style="max-height:100px; width:100%; object-fit:contain;">
            <?php } ?>
        </div>
    </div>
</div>
