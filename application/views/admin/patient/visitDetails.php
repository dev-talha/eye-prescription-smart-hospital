            ...
            <div class="col-md-12 itemcol">
                <div class="nav-tabs-custom relative">                   
                    <ul class="nav nav-tabs border-0 navlistscroll">
                        ...
                        <li><a href="#eye_prescription" data-toggle="tab" aria-expanded="true"><i class="fa fa-eye"></i> Eye Prescription</a></li>
        ...
        ?>      
                        ...
                        <div class="tab-pane" id="eye_prescription">
                            <div class="box-tab-header">
                                ...
                                <div class="box-tab-tools">
                                    <a href="<?php echo base_url('admin/eyeprescription/add/'.$result['patient_id'].'/'.$opdid.'/'.$visitminid); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Eye Prescription</a>
                                </div>
                            </div>
                            <div class="timeline-header no-border">
                        ...
                        <script>
                            var eyeRxLoaded = false;
                            $(document).ready(function() {
                                $('a[href="#eye_prescription"]').on('shown.bs.tab', function (e) {
                                    if(!eyeRxLoaded) {
                                        var patient_id = <?php echo $result['patient_id']; ?>;
                                        var visit_id = <?php echo isset($visitminid) ? $visitminid : "''"; ?>;
                                        $.ajax({
                                            url: base_url + 'admin/eyeprescription/getByVisitAjax',
                                            type: "POST",
