            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs navlistscroll">
                        ...
                        <li><a href="#eyeprescription" data-toggle="tab" aria-expanded="true"><i class="fas fa-eye"></i> <?php echo $this->lang->line('eye_prescription') ? $this->lang->line('eye_prescription') : 'Eye Prescription'; ?></a></li>
...
?>
    ...
    <i class="fa fa-print"></i>
                        ...
                        <div class="tab-pane" id="eyeprescription">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title"><?php echo $this->lang->line('eye_prescription') ? $this->lang->line('eye_prescription') : 'Eye Prescription'; ?></h3>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example">
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        if (!empty($eye_prescriptions)) {
                                            foreach ($eye_prescriptions as $eye_pres) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $this->customlib->getPatientSessionPrefixByType('opd_prescription') . $eye_pres['id']; ?></td>
                                                    <td><?php echo date($this->customlib->getHospitalDateFormat(), strtotime($eye_pres['date'])); ?></td>
                                                    <td><?php echo $eye_pres['doctor_name'] . " " . $eye_pres['doctor_surname'] . " (" . $eye_pres['doctor_employee_id'] . ")"; ?></td>
                                                    <td class="text-right">
                                                        <a href="javascript:void(0);" class="btn btn-default btn-xs view_eye_prescription" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-record-id="<?php echo $eye_pres['id']; ?>">
                                                            <i class="fa fa-reorder"></i>
                                                        </a>
                                                        <a href="<?php echo base_url(); ?>patient/eyeprescription/printPrescription/<?php echo $eye_pres['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('print'); ?>" target="_blank">
                                                            <i class="fa fa-print"></i>
                                                        </a>
                                                    </td>
                                                </tr>
...
<?php $this->load->view("patient/eyeprescription/_eye_script"); ?>
